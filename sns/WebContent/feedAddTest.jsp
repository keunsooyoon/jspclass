...
<%
	...
	/* requst.getInputStream() 를 이용해서 stream형태로 읽을 수 있게 객체를 생성, 한글처리 포함 */
	BufferedReader br = new BufferedReader(isr);
	/* 메세지 스트림을 버퍼에 저장하기위해 객체 생성 (-> 라인 단위로 읽어오기 위해 필요) */
	while((line = br.readLine()) != null) {
		str += line;
	} //readLine()를 이용해서 스트림을 라인단위로 읽어서 str로 추가
	out.print(str); //완성된 str을 출력
%>
